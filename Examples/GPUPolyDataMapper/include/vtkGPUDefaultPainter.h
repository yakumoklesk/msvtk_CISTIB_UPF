...
// .NAME vtkGPUDefaultPainter - sets up a default chain of painters.
// 
// .SECTION Description
...
// \<Delegate of vtkGPUDefaultPainter\>.
...
#ifndef __VTKGPUDEFAULTPAINTER_H__
#define __VTKGPUDEFAULTPAINTER_H__
...
//class VTK_RENDERING_EXPORT vtkGPUDefaultPainter : public vtkPainter
class vtkGPUDefaultPainter : public vtkPainter
{
public:
    static vtkGPUDefaultPainter *New();
    vtkTypeMacro(vtkGPUDefaultPainter, vtkPainter);
...
private:
    vtkGPUDefaultPainter(const vtkGPUDefaultPainter &); // Not implemented
    void operator=(const vtkGPUDefaultPainter &);    // Not implemented
};

#endif  // __VTKGPUDEFAULTPAINTER_H__
