...
if( MSVTK_VTK_BUILD_OPTIONS )
  list( APPEND additional_vtk_cmakevars ${MSVTK_VTK_BUILD_OPTIONS} )
endif()

if( MSVTK_BUILD_SHARED_LIBS )
  set( BUILD_SHARED_LIBS ${MSVTK_BUILD_SHARED_LIBS} )
endif()

LOG_DEBUG( "MSVTK_VTK_BUILD_OPTIONS ${MSVTK_VTK_BUILD_OPTIONS}" )
LOG_DEBUG( "MSVTK_BUILD_SHARED_LIBS ${MSVTK_BUILD_SHARED_LIBS}" )
LOG_DEBUG( "BUILD_SHARED_LIBS ${BUILD_SHARED_LIBS}" )
