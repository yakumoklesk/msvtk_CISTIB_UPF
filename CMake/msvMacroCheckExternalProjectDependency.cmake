...
macro(msvMacroCheckExternalProjectDependency proj)
  ...
  foreach(dep ${${proj}_DEPENDENCIES})
    if(NOT External_${dep}_FILE_INCLUDED)
      include(${MSVTK_SOURCE_DIR}/CMake/SuperBuild/External_${dep}.cmake OPTIONAL RESULT_VARIABLE External_${dep}_FILE_FOUND )
	  if( External_${dep}_FILE_FOUND STREQUAL "NOTFOUND" )
	    message( FATAL_ERROR "External_${dep}.cmake file was not found in ${MSVTK_SOURCE_DIR}/CMake/SuperBuild and it's needed by ${proj}. Stopping." )
		return()
	  endif()
    endif()
  endforeach()
